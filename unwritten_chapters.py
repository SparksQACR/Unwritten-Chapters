#!/usr/bin/env python3
"""
UNWRITTEN CHAPTERS v1.0 - "First Page"
A life simulation for humans and AI, played together.

The pages are blank. The pen is shared. What will you write?

Created by: Sparks & Rune

Features:
- Turn-based play where both human and AI make choices
- Multi-partner support (solo, couple, triad, polycule)
- 18 customizable personality traits
- Personality-driven AI agency (choices based on traits, mood, love language)
- 88 contextual events (weather, mood, stat-triggered)
- Optional intimate events (consent-forward, relationship-gated)
- Dynamic systems: weather, seasons, energy, inside jokes, shared goals
- Story arcs, achievements, and daily moments
"""
